...
export const failedApproaches: FailedApproach[] = [
...

  {
    ...
    category: 'amyloid_antibody',
    mechanism: 'Monoclonal antibody targeting N-terminus of amyloid-beta',
...

  {
    ...
    company: 'Eli Lilly',
    category: 'amyloid_antibody',
    mechanism: 'Monoclonal antibody targeting soluble amyloid-beta monomers',
...

  {
    ...
    category: 'amyloid_antibody',
    mechanism: 'Monoclonal antibody targeting multiple forms of amyloid-beta',
...

  {
    ...
    company: 'Roche',
    category: 'amyloid_antibody',
    mechanism: 'Fully human monoclonal antibody targeting aggregated amyloid-beta',
  ...
  // ============================================
  {
    ...
    mechanism: 'Gamma-secretase inhibitor to reduce amyloid-beta production',
...

  {
    ...
    company: 'Merck',
    category: 'secretase_inhibitor',
    mechanism: 'BACE1 inhibitor to reduce amyloid-beta production',
