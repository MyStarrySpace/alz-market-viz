...
export const bibliography: Source[] = [
  ...
  // ============================================
  {
    ...
    url: 'https://pubmed.ncbi.nlm.nih.gov/32105735/',
    citations: [
      {
        id: 'nixon-lysosome-rescue',
        quote: 'Isoproterenol and related β2-adrenergic agonists re-acidify lysosomes in PSEN1 KO cells and fibroblasts from PSEN1 familial AD (FAD) patients, which restores lysosomal proteolysis, calcium homeostasis, and normal autophagy flux.',
        usedIn: ['trialBarriers'],
        context: 'Proof of concept that lysosomal acidification can be pharmacologically rescued.',
      },
      {
        id: 'nixon-therapeutic-potential',
        quote: 'Our findings uncover a broadened PSEN1 role in lysosomal ion homeostasis and novel pH modulation of lysosomes through β2-adrenergic regulation of ClC-7, which can potentially be modulated therapeutically.',
        usedIn: ['trialBarriers'],
        context: 'Therapeutic potential of lysosome acidification approach.',
      },
    ],
  },
  {
    id: 'nixon-panthos-2022',
    type: 'news',
    authors: ['Ralph Nixon'],
    title: 'NeuroVoices: Ralph Nixon, MD, PhD, on Autolysosome Acidification in Alzheimer Disease and Changing Perceptions of Amyloid β',
    publication: 'NeurologyLive',
    year: 2022,
    url: 'https://www.neurologylive.com/view/neurovoices-ralph-nixon-autolysosome-acidification-alzheimer-disease-and-changing-perceptions-amyloid-',
    citations: [
      {
        id: 'nixon-earliest-pathology',
        quote: 'The very first thing that happens in a in these mice is an abnormality of the lysosome. The lysosomes start to lose the ability to acidify.',
        usedIn: ['trialBarriers'],
        context: 'Lysosome dysfunction precedes amyloid pathology.',
      },
      {
        id: 'nixon-paradigm-shift',
        quote: 'One has to now attack the process inside the cell, and to target these individual processes, lysosomes or whatever other autophagy dysfunction that you can reverse, and to cure the cell from inside route rather than by removing amyloid. This is a paradigm shift.',
        usedIn: ['trialBarriers'],
        context: 'Why anti-amyloid approaches may be targeting the wrong stage of disease.',
      },
      {
        id: 'nixon-amyloid-futility',
        quote: 'There\'s very little logic in removing the amyloid on the outside because the cell has already, you know, been so compromised, that it\'s going to die.',
        usedIn: ['trialBarriers'],
        context: 'Critique of extracellular amyloid removal strategy.',
      },
    ],
  },
...
// ============================================
  ...
  },
  {
    ...
    citations: [
      {
        id: 'finger-2015-result',
        quote: 'The intervention group showed significantly improved cognitive function compared with the control group, with a 25% improvement in the primary outcome.',
        usedIn: ['timeline', 'hopefulDevelopments'],
        context: 'First large RCT proving lifestyle intervention can slow cognitive decline.',
      },
    ],
  },
  {
  ...
  // ============================================
  // PROMISING FRONTIER - UNDEREXPLORED DRUGS
  // ============================================
  {
    id: 'rapamycin-phase1-2025',
    type: 'journal',
    authors: ['Jayanta Debnath', 'et al.'],
    title: 'Rapamycin treatment for Alzheimer\'s disease and related dementias: Phase 1 safety and tolerability study',
    publication: 'Nature Communications Medicine',
    year: 2025,
    doi: '10.1038/s43856-025-00904-9',
    url: 'https://www.nature.com/articles/s43856-025-00904-9',
    citations: [
      {
        id: 'rapamycin-phase1-safety',
        quote: 'Low-dose rapamycin (1 mg/day) for 8 weeks in patients with MCI or early AD demonstrated acceptable safety and tolerability profiles, with no serious adverse events attributed to the study drug.',
        usedIn: ['promisingFrontier'],
        context: 'First safety data for rapamycin in AD population—opens door for longer biomarker trials.',
      },
    ],
  },
  {
    id: 'rapamycin-feasibility-nct',
    type: 'website',
    authors: ['University of Texas Health Science Center'],
    title: 'Rapamycin - Effects on Alzheimer\'s and Cognitive Health (REACH)',
    publication: 'ClinicalTrials.gov',
    year: 2024,
    url: 'https://clinicaltrials.gov/study/NCT04629495',
    accessDate: '2025-01-14',
    citations: [
      {
        id: 'rapamycin-nct-ongoing',
        quote: 'A 12-month feasibility study to evaluate the effects of rapamycin on Alzheimer\'s disease biomarkers and cognitive function in individuals with amnestic mild cognitive impairment.',
        usedIn: ['promisingFrontier'],
        context: 'Ongoing trial will provide longer-term biomarker data for mTORC1 inhibition in MCI.',
      },
    ],
  },
  {
    id: 'nunes-lithium-2013',
    type: 'journal',
    authors: ['Marcelo A. Nunes', 'Tatiana A. Viel', 'Hudson S. Buck'],
    title: 'Microdose lithium treatment stabilized cognitive impairment in patients with Alzheimer\'s disease',
    publication: 'Current Alzheimer Research',
    year: 2013,
    volume: '10',
    pages: '104-107',
    doi: '10.2174/1567205011310010013',
    url: 'https://pubmed.ncbi.nlm.nih.gov/22746245/',
    citations: [
      {
        id: 'nunes-2013-stabilization',
        quote: 'Microdose lithium treatment stabilized cognitive impairment in elderly individuals with amnestic mild cognitive impairment.',
        usedIn: ['promisingFrontier', 'caseStudies'],
        context: 'Key human evidence for low-dose lithium efficacy in early cognitive decline.',
      },
    ],
  },
  {
    id: 'nature-lithium-2025',
    type: 'journal',
    ...
    citations: [
      {
        id: 'nature-lithium-2025-dose',
        quote: 'Mixed results across small trials suggest that lower concentrations may be where signal lives—not the high doses used in bipolar treatment.',
        usedIn: ['promisingFrontier'],
        context: 'Supports microdose hypothesis: therapeutic window may be much lower than psychiatric dosing.',
      },
    ],
  },
  {
    id: 'colchicine-pilot-mssm',
    type: 'journal',
    authors: ['Mount Sinai Research Team'],
    title: 'A pilot study of colchicine in Alzheimer\'s disease',
    publication: 'Icahn School of Medicine at Mount Sinai',
    year: 2012,
    url: 'https://scholars.mssm.edu/en/publications/a-pilot-study-of-colchicine-in-alzheimers-disease-2',
    citations: [
      {
        id: 'colchicine-pilot-safety',
        quote: 'Pilot study demonstrated tolerability of colchicine in Alzheimer\'s disease patients with limited cognitive signals in a small sample.',
        usedIn: ['promisingFrontier'],
        context: 'Early safety data exists; modern efficacy trial never conducted.',
      },
    ],
  },
  {
    id: 'alzdiscovery-colchicine',
    type: 'website',
    authors: ['Alzheimer\'s Drug Discovery Foundation'],
    title: 'Low-dose Colchicine - Cognitive Vitality Report',
    publication: 'AlzDiscovery.org',
    year: 2024,
    url: 'https://www.alzdiscovery.org/uploads/cognitive_vitality_media/Colchicine__Low-Dose_%28drug%29.pdf',
    accessDate: '2025-01-14',
    citations: [
      {
        id: 'alzdiscovery-colchicine-review',
        quote: 'Low-dose colchicine hasn\'t been specifically tested in dementia patients in modern trials, but argues low dose probably doesn\'t worsen cognition based on other populations.',
        usedIn: ['promisingFrontier'],
        context: 'Expert review: no evidence of cognitive harm at low doses; inflammasome mechanism plausible.',
      },
    ],
  },
  {
    id: 'columbia-valacyclovir-2024',
    type: 'news',
    authors: ['Columbia Irving Medical Center'],
    title: 'Antiviral Treatment Fails to Slow Early-Stage Alzheimer\'s',
    publication: 'CUIMC News',
    year: 2024,
    url: 'https://www.cuimc.columbia.edu/news/antiviral-treatment-fails-slow-early-stage-alzheimers',
    accessDate: '2025-01-14',
    citations: [
      {
        id: 'columbia-valacyclovir-negative',
        quote: 'Antiviral treatment fails to slow early-stage Alzheimer\'s and cannot be recommended for that use case.',
        usedIn: ['promisingFrontier'],
        context: 'The "clean test" of HSV treatment hypothesis came back negative. Intellectual honesty requires acknowledging this.',
      },
      {
        id: 'columbia-valacyclovir-prevention',
        quote: 'We don\'t know whether long-term antivirals after herpes infection can prevent AD because controlled prevention trials haven\'t been done.',
        usedIn: ['promisingFrontier'],
        context: 'Prevention hypothesis remains open but practically untestable due to economics.',
      },
    ],
  },
  {
    id: 'beingpatient-valacyclovir',
    type: 'news',
    authors: ['Being Patient Staff'],
    title: 'Cold Sore Virus Concept for Alzheimer\'s Takes a Hit in Drug Trial Results',
    publication: 'Being Patient',
    year: 2024,
    url: 'https://beingpatient.com/cold-sore-virus-alzheimers-drug-trial-results/',
    accessDate: '2025-01-14',
    citations: [
      {
        id: 'beingpatient-valacyclovir-78weeks',
        quote: 'A ~78-week trial in HSV+ MCI/early AD showed no benefits vs placebo on cognition/function or major biomarkers.',
        usedIn: ['promisingFrontier'],
        context: 'Duration was adequate; stratification was correct; still no benefit. Treatment hypothesis likely negative.',
      },
    ],
  },
];
